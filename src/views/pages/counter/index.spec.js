...
function setup(counter = 0) {
    ...
    const component = shallow(<Counter counter={counter} {...actions} />);

    return {
        component,
        actions,
        buttons: component.find('button'),
        wrapper: component.find('div.coun' +
            'ter'),
    };
}
...
describe('Counter component', () => {
    it('should display count', () => {
        const { wrapper } = setup();
        expect(wrapper.text()).toMatch(/^Clicked: 0 times/);
    });
